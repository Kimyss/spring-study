...
@RestController	//@Controller + ResponseBody API를 만들어야한다, @RestController 사용하세요! ResponseEntity 사용하면 예외이기도 함
...
//	게시물 정보를 수정하는 메소드
	...
	public ResponseEntity modify(@RequestBody BoardDTO dto) {
		service.modify(dto);
		return new ResponseEntity(HttpStatus.NO_CONTENT);	//204성공코드반환
	}
